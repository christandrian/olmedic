...
<ul class="sidebar-menu">
    <li>
        <?php
        echo $this->Html->link(
        '<i class="fa fa-dashboard"></i> <span>Beranda</span>', array('controller' => 'cfrontdesk',
        'action' => 'dashboard',
        'full_base' => true
        ), array('escape' => false)
        );
    ...
    <li class="treeview active">
        ...
        <ul class="treeview-menu">
            <li>
                <?php
                echo $this->Html->link(
                '<i class="fa fa-angle-double-right"></i><span>Tambah Item</span>', array('controller' => 'cfrontdesk',
            ...
            <li>
                <?php
                echo $this->Html->link(
                '<i class="fa fa-angle-double-right"></i><span>Tambah Paket</span>', array('controller' => 'cfrontdesk',
                'action' => 'addNewPacket',
                'full_base' => true
                ), array('escape' => false)
                );
            ...
            <li><?php
                echo $this->Html->link(
                '<i class="fa fa-angle-double-right"></i><span>Tambah Jasa</span>', array('controller' => 'cfrontdesk',
            ...
            <li><?php
                echo $this->Html->link(
                '<i class="fa fa-angle-double-right"></i><span>Tambah Kategori</span>', array('controller' => 'cfrontdesk',
            ...
            <li><?php
                echo $this->Html->link(
                '<i class="fa fa-angle-double-right"></i><span>Tambah Brand</span>', array('controller' => 'cfrontdesk',
                'action' => 'addNewBrand',
                'full_base' => true
                ), array('escape' => false)
                );
    ...
    <li>
        <?php
        echo $this->Html->link(
        '<i class="fa fa-money"></i> <span>Pembayaran</span>', array('controller' => 'cfrontdesk',
        'action' => 'payment',
        'full_base' => true
        ), array('escape' => false)
        );
    ...
    <li>
        <?php
        echo $this->Html->link(
        '<i class="fa fa-file-text"></i> <span>Laporan</span>', array('controller' => 'cfrontdesk',
        'action' => 'reports',
        'full_base' => true
        ), array('escape' => false)
        );
                ...
                <form class="form-horizontal" method ="post" action="updateItem">
                    ...
                    <div id="non-exist" style="display:visible;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="price_purch_med_show" name="price_purch_med_show" placeholder="Obat" required>
                ...
                <form class="form-horizontal" method ="post" action="restockItem">
                    ...
                    <div id="exist" style="display:visible;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="add_med" id="add_med" placeholder="Obat" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="nomor" class="col-sm-3 control-label">Satuan di Gudang:</label>
                        ...
                        <div class="form-group">
                            <label for="nomor" class="col-sm-3 control-label">Harga Beli :</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="purch_price_med" name="purch_price_med" placeholder="Obat" required>
                            </div>										
                        </div>
                        ...
                        <div class="form-group">
                            <label for="nomor" class="col-sm-3 control-label">Harga Jual:</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="sell_price_med" name="sell_price_med" placeholder="Obat" required>
                            </div>										
                        </div>
                ...
                <form class="form-horizontal" method="post" action="updateService">
                    <div id="non-exist" style="display:visible;">
                        ...
                        <div class="form-group">
                            <label for="nomor" class="col-sm-3 control-label">Nama:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="name_serv_show" name="name_serv_show" placeholder="Obat" required>
                        ...
                        <div class="form-group">
                            <label for="nomor" class="col-sm-3 control-label">Deskripsi:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="desc_serv_show" name="desc_serv_show" placeholder="Obat" required>
